...
| Recorded full local package run | The integrated 2,318-assertion package corpus (2,270 core plus 48 executable tutorials) passes on Julia 1.12.6 and the minimum supported Julia 1.10.11 |
