...
output_path="${repository_root}/test/oracle/generated/tier_b_oracle.json"
engine="auto"
...
if [[ "$selected_engine" == "matlab" ]]; then
    ...
    "$matlab_binary" -batch \
        "addpath('${escaped_directory}'); run_tier_b_oracle"
else
