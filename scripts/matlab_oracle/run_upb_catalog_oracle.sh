...
output_path="${repository_root}/test/oracle/generated/upb_catalog_oracle.json"
engine="auto"
...
if [[ "$selected_engine" == "matlab" ]]; then
    ...
    "$matlab_binary" -batch \
        "addpath('${escaped_directory}'); run_upb_catalog_oracle"
else
